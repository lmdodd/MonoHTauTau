...
if [ $weight -eq 1 ]
then
    nohup EventWeightsIterativeFixMe  outputFile='EWK.root' &
    nohup EventWeightsIterativeFixMe  outputFile='EWKW.root' &
    nohup EventWeightsIterativeFixMe  outputFile='EWKZ.root' &
