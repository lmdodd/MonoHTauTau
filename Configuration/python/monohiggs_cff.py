...
ETanalysisConfigurator.addSelector('eleTausTauIsolation','PATEleTauPairSelector','leg2.tauID("byMediumIsolationMVArun2v1DBoldDMwLT") > 0.5','ETTauMediumIso',1)
...
MTanalysisConfigurator.addSelector('muTausTauID','PATMuTauPairSelector','leg2.tauID("byMediumIsolationMVArun2v1DBoldDMwLT")>0.5','MTTauID',1)
...
TTanalysisConfigurator.addSelector('diTaus1TauLooseIsolation','PATDiTauPairSelector','leg1.tauID("byLooseIsolationMVArun2v1DBoldDMwLT")>0.5','TTTauLooseIso1',1)
TTanalysisConfigurator.addSelector('diTaus2TauLooseIsolation','PATDiTauPairSelector','leg2.tauID("byLooseIsolationMVArun2v1DBoldDMwLT")>0.5','TTTauLooseIso2',1)
...
TTanalysisConfigurator.addSelector('diTausTau1Isolation','PATDiTauPairSelector','leg1.tauID("byVTightIsolationMVArun2v1DBoldDMwLT")>0.5','TTTauTightIso1',1)
TTanalysisConfigurator.addSelector('diTausTau2Isolation','PATDiTauPairSelector','leg2.tauID("byVTightIsolationMVArun2v1DBoldDMwLT")>0.5','TTTauTightIso2',1)
