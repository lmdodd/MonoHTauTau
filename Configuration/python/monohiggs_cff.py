...
ETanalysisConfigurator.addSelector('eleTausElePtEta','PATEleTauPairSelector','leg1.pt()>26&&abs(leg1.eta())<2.1','ETelectronPtEta',1)
ETanalysisConfigurator.addSelector('eleTausTauPtEta','PATEleTauPairSelector','leg2.pt()>19.5&&abs(leg2.eta())<2.3','ETTauPtEta',1)
...
ETanalysisConfigurator.addSelector('eleTausTauLooseIsolation','PATEleTauPairSelector','leg2.tauID("byLooseIsolationMVArun2v1DBdR03oldDMwLT") > 0.5','ETTauLooseIso',1)
ETanalysisConfigurator.addSelector('eleTausTauMuonLooseVeto','PATEleTauPairSelector','leg2.tauID("againstMuonLoose3")','ETAgainstMuon',1)
ETanalysisConfigurator.addSelector('eleTausTauElectronLooseVeto','PATEleTauPairSelector','leg2.tauID("againstElectronVLooseMVA6")>0','ETAgainstElectron',1)
...
ETanalysisConfigurator.addSelector('eleTausTauIsolation','PATEleTauPairSelector','leg2.tauID("byMediumIsolationMVArun2v1DBdR03oldDMwLT") > 0.5','ETTauMediumIso',1)
...
#Make DiTaus   
MTanalysisConfigurator.addDiCandidateModule('muTaus','PATMuTauPairProducer','smearedMuonsMT','smearedTausMT','smearedMETMT','smearedTausMT','smearedJetsMT',1,9999,text='AtLeastOneMuTau',leadingObjectsOnly = False,dR = 0.3,recoMode ="",genParticles='prunedGenParticles')
MTanalysisConfigurator.addSelector('muTausMuonPtEta','PATMuTauPairSelector','leg1.pt()>26&&abs(leg1.eta())<2.4','MTMuonPtEta',1)
MTanalysisConfigurator.addSelector('muTausTauPtEta','PATMuTauPairSelector','leg2.pt()>19.5&&abs(leg2.eta())<2.3','MTTauPtEta',1)
MTanalysisConfigurator.addSelector('muTausMuonLooseID','PATMuTauPairSelector','leg1.isLooseMuon','MTMuonTightID',1)
...
MTanalysisConfigurator.addSelector('muTausTauLooseID','PATMuTauPairSelector','leg2.tauID("byLooseIsolationMVArun2v1DBdR03oldDMwLT")>0.5','MTTauLooseID',1)
MTanalysisConfigurator.addSelector('muTausTauElectronLooseVeto','PATMuTauPairSelector','leg2.tauID("againstElectronVLooseMVA6")>0.5','MTAgainstElectron',1)
MTanalysisConfigurator.addSelector('muTausTauMuonLooseVeto','PATMuTauPairSelector','leg2.tauID("againstMuonLoose3")>0.5','MTAgainstElectron',1)
...
MTanalysisConfigurator.addSelector('muTausTauID','PATMuTauPairSelector','leg2.tauID("byMediumIsolationMVArun2v1DBdR03oldDMwLT")>0.5','MTTauID',1)
...
TTanalysisConfigurator.addSelector('diTausTau1PtEta','PATDiTauPairSelector','leg1.pt()>39&&abs(leg1.eta())<2.1','TTTau1PtEta',1)
TTanalysisConfigurator.addSelector('diTausTau2PtEta','PATDiTauPairSelector','leg2.pt()>39&&abs(leg2.eta())<2.1','TTTau2PtEta',1)
...
TTanalysisConfigurator.addSelector('diTausTau1Isolation','PATDiTauPairSelector','leg1.tauID("byTightIsolationMVArun2v1DBdR03oldDMwLT")>0.5','TTTauTightIso1',1)
TTanalysisConfigurator.addSelector('diTausTau2Isolation','PATDiTauPairSelector','leg2.tauID("byTightIsolationMVArun2v1DBdR03oldDMwLT")>0.5','TTTauTightIso2',1)
TTanalysisConfigurator.addSelector('diTausTau1MuonVeto','PATDiTauPairSelector','leg1.tauID("againstMuonLoose3")','TTAgainstMuon1',1)
TTanalysisConfigurator.addSelector('diTausTau2MuonVeto','PATDiTauPairSelector','leg2.tauID("againstMuonLoose3")','TTAgainstMuon2',1)
TTanalysisConfigurator.addSelector('diTausTau1ElectronVeto','PATDiTauPairSelector','leg1.tauID("againstElectronVLooseMVA6")>0','TTAgainstElectron1',1)
TTanalysisConfigurator.addSelector('diTausTau2ElectronVeto','PATDiTauPairSelector','leg2.tauID("againstElectronVLooseMVA6")>0','TTAgainstElectron2',1)
