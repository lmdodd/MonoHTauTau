...
MTanalysisConfigurator.addSelector('muTausMuonMediumID','PATMuTauPairSelector','leg1.userInt("tightID")>0','MTMuonTightID',1)
...
TTanalysisConfigurator.addSelector('diTausTau1PtEta','PATDiTauPairSelector','leg1.pt()>40&&abs(leg1.eta())<2.1','TTTau1PtEta',1)
TTanalysisConfigurator.addSelector('diTausTau2PtEta','PATDiTauPairSelector','leg2.pt()>40&&abs(leg2.eta())<2.1','TTTau2PtEta',1)
...
TTanalysisConfigurator.addSelector('diTausTau1Isolation','PATDiTauPairSelector','leg1.tauID("byVTightIsolationMVArun2v1DBdR03oldDMwLT")>0.5','TTTauTightIso1',1)
TTanalysisConfigurator.addSelector('diTausTau2Isolation','PATDiTauPairSelector','leg2.tauID("byVTightIsolationMVArun2v1DBdR03oldDMwLT")>0.5','TTTauTightIso2',1)
