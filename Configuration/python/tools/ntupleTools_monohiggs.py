...
def makeMuTauMETUncert(sourceDiTaus, sourceMET, prefix, shift):
   PSet = cms.PSet(
         pluginType  = cms.string("PATMuTauPairMETFillerUncert"),
         src         = cms.InputTag(sourceDiTaus),
         met         = cms.InputTag(sourceMET),
         tag         = cms.string(prefix),
...
def makeEleTauMETUncert(sourceDiTaus, sourceMET, prefix, shift):
   PSet = cms.PSet(
         pluginType  = cms.string("PATEleTauPairMETFillerUncert"),
         src         = cms.InputTag(sourceDiTaus),
         met         = cms.InputTag(sourceMET),
         tag         = cms.string(prefix),
         uncert      = cms.string(shift)  #EnUp or EnDown Available
...
def makeDiTauCSVShape(sourceDiTaus):
   ...
   return PSet
def makeDiTauEventWeightTmp(sourceDiTaus):
   PSet = cms.PSet(
         pluginType  = cms.string("PATDiTauPairWeightFillerTmp"),
         src         = cms.InputTag(sourceDiTaus)
   )
   return PSet
...
def addMuTauEventTree(process,name,src='muTausSorted', srcLL='diMuonsOSSorted', srcU='TightMuons', srcE='TightElectrons',srcT='TightTaus'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              muTauUserMediumGHID = makeMuTauPair(src,"id_m_GHmedium_1",'leg1.userInt("mediumGHID")'),
                              ...
                              muTauJetsPt30nbtag = makeMuTauJetCountPair(src,"nbtag30NoSF",'pt()>30&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>.8484'),
...
def addEleTauEventTree(process,name,src='eleTausSorted',srcLL='diElectronsOSSorted', srcU='TightMuons', srcE='TightElectrons',srcT='TightTaus'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              eleTaubyLooseIsolationMVArun2v1DBdR03oldDMwLT = makeEleTauPair(src,"byLooseIsolationMVArun2v1DBdR03oldDMwLT_2",'leg2.tauID("byLooseIsolationMVArun2v1DBdR03oldDMwLT")'),
                              eleTaubyMediumIsolationMVArun2v1DBdR03oldDMwLT = makeEleTauPair(src,"byMediumIsolationMVArun2v1DBdR03oldDMwLT_2",'leg2.tauID("byMediumIsolationMVArun2v1DBdR03oldDMwLT")'),
                              ...
                              eleTaubyVTightIsolationMVArun2v1DBdR03oldDMwLT = makeEleTauPair(src,"byVTightIsolationMVArun2v1DBdR03oldDMwLT_2",'leg2.tauID("byVTightIsolationMVArun2v1DBdR03oldDMwLT")'),
                              ...
                              #Jets
                              eleTauJetsPt20nbtag = makeEleTauJetCountPair(src,"nbtag",'userFloat("isbtagged")&&pt()>20&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>0.8484'),
                              eleTauJetsPt20nbtagNoSF = makeEleTauJetCountPair(src,"nbtagNoSF",'pt()>20&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>0.8484'),
                              eleTauJetsPt20nbtagLoose = makeEleTauJetCountPair(src,"nbtagLooseNoSF",'pt()>20&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>0.5426'),
                              eleTauJetsPt30nbtagNoSF = makeEleTauJetCountPair(src,"nbtag30NoSF",'pt()>30&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>0.8484'),
                              eleTauJetsPt30nbtag = makeEleTauJetCountPair(src,"nbtag30",'userFloat("isbtagged")&&pt()>30&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>0.8484'),
                              ...
                              eleTauBJet1CSVPtSort = makeEleTauPtPair(src,"bcsv_1",'abs(eta())<2.4&&pt()>20&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>.8484','bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")',0),
                              eleTauBJet2CSVPtSort = makeEleTauPtPair(src,"bcsv_2",'abs(eta())<2.4&&pt()>20&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>.8484','bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")',1),
...
def addDiTauEventTree(process,name,src='diTausSorted', srcU='TightMuons', srcE='TightElectrons'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              diTauJetsPt30nbtagNoSF = makeDiTauJetCountPair(src,"nbtag30NoSF",'pt()>30&&abs(eta)<2.4&&userFloat("idLoose")&&bDiscriminator("pfCombinedInclusiveSecondaryVertexV2BJetTags")>.8484'),
                              ...
                              diTaubyTightIsolationMVArun2v1DBoldDMwLT_1 = makeDiTauPair(src,"byTightIsolationMVArun2v1DBoldDMwLT_1",'leg1.tauID("byTightIsolationMVArun2v1DBoldDMwLT")'),
                              ...
                              diTauagainstElectronMediumMVA6_2 = makeDiTauPair(src,"againstElectronMediumMVA6_2",'leg2.tauID("againstElectronMediumMVA6")'),
                              diTauagainstElectronTightMVA6_1 = makeDiTauPair(src,"againstElectronTightMVA6_1",'leg1.tauID("againstElectronTightMVA6")'),
                              diTauagainstElectronTightMVA6_2 = makeDiTauPair(src,"againstElectronTightMVA6_2",'leg2.tauID("againstElectronTightMVA6")'),
                              diTauagainstElectronVTightMVA6_1 = makeDiTauPair(src,"againstElectronVTightMVA6_1",'leg1.tauID("againstElectronVTightMVA6")'),
                              diTauagainstElectronVTightMVA6_2 = makeDiTauPair(src,"againstElectronVTightMVA6_2",'leg2.tauID("againstElectronVTightMVA6")'),
                              diTauagainstMuonLoose3_1 = makeDiTauPair(src,"againstMuonLoose3_1",'leg1.tauID("againstMuonLoose3")'),
                              diTauagainstMuonLoose3_2 = makeDiTauPair(src,"againstMuonLoose3_2",'leg2.tauID("againstMuonLoose3")'),
                              diTauagainstMuonTight3_1 = makeDiTauPair(src,"againstMuonTight3_1",'leg1.tauID("againstMuonTight3")'),
                              diTauagainstMuonTight3_2 = makeDiTauPair(src,"againstMuonTight3_2",'leg2.tauID("againstMuonTight3")'),
